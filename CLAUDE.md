...
TwoDot UI - A modern React TypeScript application built with Vite. This project uses React 18 with TypeScript for type safety and Vite for fast development and optimized production builds.
...
- **TypeScript 5.5** - Static type checking and enhanced IDE support
